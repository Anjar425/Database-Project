<div id="insertModal" class="hidden fixed inset-0 bg-gray-400 bg-opacity-60 justify-center items-center ">
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="save-kematian" class=" w-5/6 mx-auto my-5">
            @csrf
            <h2 class=" text-center font-semibold text-lg text-white">Insert Kematian</h2><br>
            ...
            <div class="flex flex-row gap-3">
                ...
                <div class="flex flex-row gap-3">
                    <div class="mb-5 basis-1/2">
                        <label for="Jam" class="block mb-2 text-sm font-medium  text-white">Jam Kematian</label>
                        <input name="Jam" type="time" id="Jam"
                            class=" border  text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="mb-5 basis-1/2">
                        <label for="Tanggal" class="block mb-2 text-sm font-medium text-white">Tanggal Kematian</label>
