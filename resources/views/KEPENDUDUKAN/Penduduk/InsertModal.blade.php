<div id="insertModal" class="hidden fixed inset-0 bg-gray-400 bg-opacity-60 justify-center items-center ">
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="save-penduduk" class=" w-5/6 mx-auto my-5">
            @csrf
            ...
            <div class="flex flex-row gap-3">
                ...
                <div class="basis-1/2 mb-5">
                    <label for="JenisKelamin" class="block mb-2 text-sm font-medium  text-white">Jenis Kelamin</label>
            ...
            <div class="flex flex-row gap-3">
                ...
                <div class="mb-5 basis-1/2">
                    <label for="TanggalLahir" class="block mb-2 text-sm font-medium text-white">Tanggal Lahir</label>
