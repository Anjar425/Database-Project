@foreach ($pekerjaan as $p)
    <div id="editModal{{ $p->IDPekerjaan }}"
        ...
        <div class="bg-gray-800 rounded-lg w-1/2">
            <form method="POST" action="{{ url('/' . $p->IDPekerjaan . '/update-pekerjaan') }}"
                ...
                <div class="flex flex-row gap-3">
                    <div class="mb-5 basis-1/2">
                        <label for="NamaPekerjaan" class="block mb-2 text-sm font-medium text-white">Nama
                            Pekerjaan</label>
                        <input name="NamaPekerjaan" type="text" id="NamaPekerjaan"
                            class=" border  text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                            value="{{ $p->NamaPekerjaan }}">
                    </div>

                    <div class="mb-5 basis-1/2">
                        <label for="LokasiPekerjaan" class="block mb-2 text-sm font-medium  text-white">Lokasi
                            Pekerjaan</label>
                        <input name="LokasiPekerjaan" type="text" id="LokasiPekerjaan"
                            class=" border  text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                            value="{{ $p->LokasiPekerjaan }}">
                    </div>
                </div>
