@foreach ($pns as $p)
    <div id="editModal{{ $p->IDPekerjaan }}"
        ...
        <div class="bg-gray-800 rounded-lg w-1/2">
            <form method="POST" action="{{ url('/' . $p->IDPekerjaan . '/update-pns') }}" class=" w-5/6 mx-auto my-5">
                @csrf
                <h2 class=" text-center font-semibold text-lg text-white">Edit PNS</h2><br>
                <div class="mb-5">
                ...
                <div class="flex flex-row gap-3">
                    <div class="mb-5 basis-1/2">
                        <label for="NIP"
                            class="block mb-2 text-sm font-medium  text-white">NIP</label>
                    ...
                    <div class="mb-5 basis-1/2"">
                        <label for="PJabatan"
                            class="block mb-2 text-sm font-medium text-white">Jabatan</label>
                        <input name="PJabatan" type="text" id="PJabatan"
                            class=" border  text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                            value="{{ $p->PJabatan }}">
                    </div>
                </div>
                <div class="mb-5">
                    <label for="NamaInstansi"
                        class="block mb-2 text-sm font-medium  text-white">Nama Instansi</label>
                ...
                <div class="mb-5">
                    <label for="Kontak"
                        class="block mb-2 text-sm font-medium  text-white">Kontak</label>
