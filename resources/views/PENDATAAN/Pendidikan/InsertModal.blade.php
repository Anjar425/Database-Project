<div id="insertModal" class="hidden fixed inset-0 bg-gray-400 bg-opacity-60 justify-center items-center ">
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="save-pendidikan" class=" w-5/6 mx-auto my-5">
            @csrf
            ...
            <div class=" basis-1/2 mb-5">
                <label for="NamaInstansi" class="block mb-2 text-sm font-medium  text-white">Nama Instansi</label>
            ...
            <div class="mb-5">
                <label for="NoIDNasional" class="block mb-2 text-sm font-medium  text-white">No ID Nasional</label>
