<div id="insertModal" class="hidden fixed inset-0 bg-gray-400 bg-opacity-60 justify-center items-center ">
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="save-penghasilan" class=" w-5/6 mx-auto my-5">
            @csrf
            ...
            <div class="mb-5">
                <label for="JumlahPenghasilan" class="block mb-2 text-sm font-medium  text-white">Jumlah Penghasilan</label>
