<div id="insertModal" class="hidden fixed inset-0 bg-gray-400 bg-opacity-60 justify-center items-center ">
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="save-penyakit" class=" w-5/6 mx-auto my-5">
            @csrf
            <h2 class=" text-center font-semibold text-lg text-white">Insert Penyakit</h2><br>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="NamaPenyakit" class="block mb-2 text-sm font-medium  text-white">Nama Penyakit</label>
